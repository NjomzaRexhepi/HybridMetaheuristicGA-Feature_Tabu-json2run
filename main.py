...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_file", type=str, default="B2.5k_L3_D90 (Appalachian Regional Project).txt", help="Input File")
    parser.add_argument("--max_evaluations", type=int, default=20,
                        help="Maximum number of hyperparameter configurations to try.")
    parser.add_argument("--neps_root_dir", type=str, default="neps_results_B2.5k_L3_D90 (Appalachian Regional Project)_max",
